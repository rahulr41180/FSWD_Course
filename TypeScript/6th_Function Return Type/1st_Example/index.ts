...
function add6(num1: number, num2: number): void {
    console.log(num1 + num2);
}
...
function add7(num1: number, num2: number): undefined {
    console.log(num1 + num2);
}
...
function add8(num1: number, num2: number): undefined { // undefined type
    console.log(num1 + num2);
    return;
}
...
function add9(num1: number, num2: number): void { // void type
    console.log(num1 + num2);
    return;
}
...
function add10(num1: number, num2: number) { // nothing to assign as type
    console.log(num1 + num2);
    return;
}
...
function add11(num1: number, num2: number): void { // we should always assign void type to function if function is not returning anything or if we have just written return;
    console.log(num1 + num2);
    return;
}

console.log(add11(1,4)); // undefined