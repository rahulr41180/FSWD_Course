...
export const ProductPage = () => {
    ...
    return (
        <Layout title={"All Products | rR FASTeSTORE"}>
            {loading ?
                <div className="container-fluid pp_container1 d-flex justify-content-center align-items-center">
                    <div className="width50 height50 d-flex justify-content-center align-items-center gap-4">
